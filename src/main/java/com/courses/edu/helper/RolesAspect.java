...
public class RolesAspect {
	...
	public Object doSomething(ProceedingJoinPoint jp) throws Throwable {
		...
		Set<Role> roles = Arrays
				.stream(((MethodSignature) jp.getSignature()).getMethod().getAnnotation(Roles.class).value())
		...
		return ResponseEntity.status(HttpStatus.FORBIDDEN)
				.body(new ResponseObject("403", "Access Denied", "You do not have permission to access this URL"));
	}
